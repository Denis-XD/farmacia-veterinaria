...
@section('content')
    <div class="">
        ...
        <h2 class="text-center mt-3">Todos los Usuarios</h2>
        @if (session('success'))
    ...
    @can('usuario_crear')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title small text-muted mb-3" id="importModalLabel2">Columnas: [Nombre, Celular,
                            Email, Habilitado, Rol]</h6>
        ...
        <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title w-100 text-center" id="addUserModalLabel">Agregar nuevo usuario</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="roles[]" aria-label="Default select">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre"
                                    placeholder="Nombre" pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚ ]+" maxlength="40" minlength="3"
                            ...
                            <div class="mb-3 row">
                                <div class="col-8">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="Email" maxlength="50" minlength="5"
                                        oninput="this.value = this.value.toLowerCase().substring(0, 50)" required>
                                </div>
                                <div class="col-4 d-flex align-items-center">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="active" name="active"
                                            checked>
                                        <label class="form-check-label" for="active">Habilitado</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="d-flex justify-content-center mb-3 mt-n5">
        <form action="{{ route('usuarios.index') }}" method="GET" class="d-flex justify-content-center">
            <div class="input-group rounded d-flex justify-content-center">
                ...
                <div class="d-flex">
                    ...
                    <a href="{{ route('usuarios.index') }}" class="btn btn-secondary d-flex align-items-center gap-1">
                        <div style="display: inline-flex; align-items: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#ffffff"
                                style="width: 1.5rem; height: 1.5rem;"> <!-- Estilo para el icono -->
                                <path
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="bg-light">Rol</th>
            ...
            <tbody>
                @foreach ($usuarios as $usuario)
                    <tr>
                        <td class="sticky-id bg-light">{{ $usuario->id }}</td>
                                ...
                                @can('usuario_actualizar')
                                    <div class="modal fade" id="editUserModal{{ $usuario->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title w-100 text-center" id="editUserModalLabel">Editar
                                                        usuario</h5>
                                                ...
                                                <form method="POST" action="{{ route('users.update', $usuario->id) }}">
                                                    ...
                                                    <div class="modal-body ">
                                                        ...
                                                        <div class="mb-3 mx-3">
                                                            <label for="celular_usuario"
                                                                class="form-label -mt-2">Celular:</label>
                                                            <input type="text" class="form-control" id="celular_usuario"
                                                                name="celular_usuario"
                                                                value="{{ $usuario->celular_usuario }}" placeholder="Celular"
                                                        ...
                                                        <div style="">
                                                            <div class="mb-3 mx-3">
                                                                ...
                                                                <input type="email" class="form-control" id="email"
                                                                    ...
                                                                    placeholder="Email" maxlength="50" minlength="5"
                                                                    oninput="this.value = this.value.toLowerCase().substring(0, 50)"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 mx-2 justify-content-between">
                                                            <div class="col-4 ">
                                                                <label for="id_rol" class="form-label">Rol de
                                                                    usuario:</label>
                                                                <select class="form-select" name="roles">
                                                                    @if ($usuario->roles->isEmpty())
                                                                        <option value="" selected disabled>Ningún rol
                                                                            seleccionado</option>
                                                                    @endif
                                                                    @foreach ($roles as $id => $role)
                                                                        <option value="{{ $id }}"
                                                                            @if (in_array($id, $usuario->roles->pluck('id')->toArray())) selected @endif>
                                                                            {{ $role }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-4 form-check mx-2 my-auto">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p><strong>¡Cuidado!</strong> ¿Estás seguro de que deseas
                                                        ...
                                                        y se
                                                        eliminarán todas las ventas y compras relacionadas con este usuario.
                                                    </p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center mt-4">
            ...
            @if ($usuarios->previousPageUrl())
                <li class="page-item">
                    <a class="page-link"
                        href="{{ $usuarios->previousPageUrl() . '&' . http_build_query(request()->except('page')) }}"
            ...
            @if ($usuarios->nextPageUrl())
                <li class="page-item">
                    <a class="page-link"
                        href="{{ $usuarios->nextPageUrl() . '&' . http_build_query(request()->except('page')) }}">Siguiente</a>
                </li>
            @else
                <li class="page-item disabled">
