...
@section('content')
    <div class="">
        ...
        <div class="d-flex justify-content-end my-3">
            @can('ubicacion_crear')
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addUbicacionModal"><svg
                    ...
                    Agregar</button>
                <!-- Add Ubicación Modal -->
                <div class="modal fade" id="addUbicacionModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar nueva ubicación</h1>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="nombre"
                                            ...
                                            minlength="4" maxlength="50" pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚ ]+"
                                            placeholder="Ejemplo: Biblioteca" style="text-transform:uppercase;" required>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center col">
                                    ...
                                    @can('ubicacion_eliminar')
                                        <button type="button" class="btn btn-danger shadow-sm" data-bs-toggle="modal"
                                            data-bs-target="#deleteUbicacionModal{{ $ubicacion->id_ubicacion }}">Eliminar</button>
                                    @endcan
                                    <div style="width: 0.5rem;"></div>
                                    @can('ubicacion_actualizar')
                                        <button type="button" class="btn btn-info shadow-sm" data-bs-toggle="modal"
                                            data-bs-target="#editUbicacionModal{{ $ubicacion->id_ubicacion }}"
                                            style="color: white">Editar</button>
                                    @endcan
                                    <!-- Delete Ubicación Modal -->
                                    <div class="modal fade" id="deleteUbicacionModal{{ $ubicacion->id_ubicacion }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header text-white bg-danger">
                                                    ...
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Eliminar ubicación
                                                    </h1>
                                                ...
                                                <div class="modal-body">
                                                    <p><strong>¡Cuidado!</strong> ¿Estás seguro de que deseas
                                                        ...
                                                        ubicación
                                                        <strong>"{{ $ubicacion->nombre }}"</strong>?<br><br><strong>Nota:
                                                        </strong>Esta acción
                                                        no
                                                        se puede revertir
                                                        y se
                                                        eliminarán todos los ambientes relacionados con esta ubicación.
                                                    </p>
                                                </div>
                                                <div class="modal-footer">
                                    ...
                                    <!-- Edit Ubicación Modal -->
                                    <div class="modal fade" id="editUbicacionModal{{ $ubicacion->id_ubicacion }}"
                                        tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Editar ubicación
                                                    </h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <form action="{{ route('ubicaciones.update', $ubicacion) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="nombre"
                                                                name="nombre" autofocus value="{{ $ubicacion->nombre }}"
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center mt-4">
                <!-- Enlace "Anterior" -->
                @if ($ubicaciones->previousPageUrl())
                    <li class="page-item">
                        <a class="page-link" href="{{ $ubicaciones->previousPageUrl() }}" tabindex="-1"
                ...
                <!-- Enlaces de páginas -->
                @foreach ($ubicaciones->getUrlRange(1, $ubicaciones->lastPage()) as $pagina => $url)
                    <li class="page-item {{ $ubicaciones->currentPage() == $pagina ? 'active' : '' }}">
                        <a class="page-link" href="{{ $url }}">{{ $pagina }}</a>
                    </li>
                @endforeach

                <!-- Enlace "Siguiente" -->
                @if ($ubicaciones->nextPageUrl())
                    <li class="page-item">
