<div class="navbar-nav navbar-dark w-100 accordion accordion-flush" id="accordionFlush{{ $data['device'] }}">
    ...
    @canany('reglas')
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#flush-collapseReglas" aria-expanded="false" aria-controls="flush-collapseReglas">
            ...
            <div id="flush-collapseReglas" class="accordion-collapse collapse"
                data-bs-parent="#accordionFlush{{ $data['device'] }}">
                <div class="accordion-body">

                    @can('notificacion_listar')
                        <li class="nav-item">
                            <a class="nav-link @if (Route::currentRouteName() == 'reglas.index') active @endif"
                                href="{{ url('reglas') }}">Configuracion</a>
                        </li>
                    @endcan
                </div>
            </div>
